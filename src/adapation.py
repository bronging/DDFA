...
from downprompt import downprompt, downprompt2,downpromptPerm, downpromptFUG, finetune, downpromptSharedFUG
...
def adaptation_FUG_node(model, features, adj, labels, \
                           ...
                           beta, hid_units, nb_classes, unify_dim, num_layers_num,\
                            ...
                            n_mlp_layer=1, sampling='random', model_type=None, shared=False):
...
def adaptation_sharedFUG_node(model_type, model, features, adj, labels, \
                           ...
                           beta, hid_units, nb_classes, unify_dim, num_layers_num,\
                            combinetype, ablation_down, patience, save_path, epoch=400, \
                            sample_size = 182, if_rand=False, a=0.0, gamma=0.5, basis_matrix=None, n_mlp_layer=1, sampling='random', shared=False):
    ...
    for downstreamlr in downstreamlrlist:
        ...
        for shotnum in range(1,shot_num+1):
            ...
            if model_type == 'sharedFUG': 
                ...
                #high_dimension_encoder, low_dimension_encoder, balance_weights, combines = model.get_weights()
