...
def get_save_name(args, pretrain_dataset_names, save_dir, result_dir): 
    ...
    set_name = f'model_node_LP_{pretrain_dataset_str}_{args.sample_size}_{args.pre_epochs}_{args.if_rand}_{args.alpha}_{args.beta}_{args.unify_dim}_{args.hid_units}_{args.lr}_{args.backbone}'
