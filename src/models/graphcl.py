    ...
    def forward(self, gcn, seq1, seq2, seq3, seq4, adj, aug_adj1, aug_adj2, sparse, msk, samp_bias1, samp_bias2,
        ...
        if st_validation != 'origin': # corr 면
            ...
            if aug_type == 'edge':
                ...
                h_1 = gcn(seq1, aug_adj1, sparse, None, prompt_layers)
                h_3 = gcn(seq1, aug_adj2, sparse, None, prompt_layers)

            elif aug_type == 'mask':

                h_1 = gcn(seq3, adj, sparse, None, prompt_layers)
                h_3 = gcn(seq4, adj, sparse, None, prompt_layers)

            elif aug_type == 'node' or aug_type == 'subgraph':

                h_1 = gcn(seq3, aug_adj1, sparse, None, prompt_layers)
                h_3 = gcn(seq4, aug_adj2, sparse, None, prompt_layers)
            ...
            h_2 = gcn(seq2, adj, sparse, None, prompt_layers)
            ...
            ret = ret1 + ret2  # [1, 2*#nodes] = [view1, view2]
            # print(f'Graph CL ret: {ret.size()}')
            return ret
